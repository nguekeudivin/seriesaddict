...
const hero = {
  ...
  title: "Stranger Things revient avec sa saison 5 !",
...
function Hero() {
  return (
    <section className="relative h-[92vh] min-h-[680px] overflow-hidden bg-black">
      ...
      <div className="relative mx-auto flex h-full max-w-7xl flex-col justify-center px-6 pt-16 pb-16 lg:pb-20">
        <div className="max-w-3xl">
          <h1 className="bg-gradient-to-r from-white via-white to-brand-cyan bg-clip-text text-2xl font-black uppercase leading-[1.2] tracking-tight text-transparent md:text-5xl ">
            {hero.title}
          </h1>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            {[hero.platform, hero.release, hero.episodes].map((label) => (
              <span
                key={label}
          ...
          <div className="mt-8 w-3/4 max-w-2xl">
