    ...
    episodes: [
      {
        ...
        duration: 48,
        image:
          "https://images.pexels.com/photos/8107200/pexels-photo-8107200.jpeg?auto=compress&cs=tinysrgb&w=900",
        importance: "friend",
        platform: "Apple TV+",
        rating: 4.5,
      },
      {
        ...
        duration: 55,
        image:
          "https://images.pexels.com/photos/209948/pexels-photo-209948.jpeg?auto=compress&cs=tinysrgb&w=900",
        importance: "friend",
      ...
      },
      {
        ...
        duration: 52,
        image:
          "https://images.pexels.com/photos/7319307/pexels-photo-7319307.jpeg?auto=compress&cs=tinysrgb&w=900",
        importance: "friend",
        platform: "Netflix",
        rating: 4.9,
      },
    ...
    episodes: [
      {
        ...
        duration: 62,
        image:
          "https://images.pexels.com/photos/1523598455533-144bae1f0b14?auto=compress&cs=tinysrgb&w=900",
        importance: "trending",
        platform: "HBO / Max",
        rating: 4.6,
      },
      {
        ...
        duration: 45,
        image:
          "https://images.pexels.com/photos/1497215728101-856f4ea42174?auto=compress&cs=tinysrgb&w=900",
        importance: "trending",
        platform: "Apple TV+",
        rating: 4.8,
      },
...
function HeroEpisode({ episode }) {
  ...
  return (
    <BentoTile
      className="col-span-1 row-span-2 min-h-[420px] md:col-span-2"
      glow
    >
      <div className="relative flex h-full flex-col justify-end overflow-hidden rounded-2xl">
        ...
        <div className="relative p-5 md:p-7">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-4 text-sm text-white/70">
            ...
            <span className="inline-flex items-center gap-1">
              <Star className="h-4 w-4 text-yellow-500" /> {episode.rating}
            </span>
            <span className="inline-flex items-center gap-1">
              <Tv className="h-4 w-4" /> {episode.platform}
            </span>
          </div>
          <div className="mt-5 flex flex-wrap gap-3">
            <button className="inline-flex items-center gap-2 rounded-full bg-white px-5 py-2.5 text-sm font-bold text-black transition hover:bg-white/90">
              <Play className="h-4 w-4 fill-black" /> Regarder
            </button>
      ...
      <div className="flex h-full flex-col">
        <div className="mb-3 flex items-center justify-between">
          ...
          <div className="flex gap-1">
            <button
              onClick={() => scroll("left")}
              className="grid h-7 w-7 place-items-center rounded-full border border-white/10 text-white/60 hover:bg-white/10"
            >
        ...
        >
          {episodes.map((ep) => {
            ...
            return (
              <div
                key={ep.id}
                className="group/card relative w-[200px] shrink-0 overflow-hidden rounded-xl"
              >
                ...
                <div className="relative p-3">
                  ...
                  <h4 className="mt-2 truncate text-xs font-bold text-white">
                    {ep.series}
                  </h4>
                  <p className="truncate text-[10px] text-brand-cyan">
                    {ep.episodeCode}
                  </p>
    ...
    <section className="mt-10">
      <div className="mb-4 flex items-end justify-between">
        ...
        <div className="flex gap-2">
          <button
            onClick={() => scroll("left")}
            className="grid h-8 w-8 place-items-center rounded-full border border-white/10 text-white/70 hover:bg-white/10"
          >
      ...
      >
        {section.episodes.map((ep) => {
          ...
          return (
            <div
              key={ep.id}
              className="group relative w-[260px] shrink-0 overflow-hidden rounded-2xl"
            >
              ...
              <div className="relative rounded-2xl bg-brand-dark/55 backdrop-blur">
                <div className="relative aspect-[16/9] overflow-hidden rounded-t-2xl">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                    <button
                      className="grid h-12 w-12 place-items-center rounded-full text-white shadow-2xl"
                ...
                <div className="p-4">
                  <h3 className="truncate text-sm font-extrabold text-white">
                    {ep.series}{" "}
                    <span className="text-brand-cyan">{ep.episodeCode}</span>
                  </h3>
      ...
      <main className="relative z-10 mx-auto max-w-7xl px-5 pb-24">
        <section className="mb-8">
          ...
          <p className="mt-2 max-w-xl text-sm text-white/60">
            Hero Bento + Carrousels : le meilleur des deux mondes.
          </p>
        </section>
            ...
            <div className="flex h-full flex-col justify-between">
              ...
              <div>
                <p className="text-3xl font-black text-white">
                  {formatDuration(
                    TODAY_EPISODES.reduce((a, b) => a + b.duration, 0),
                  )}
                </p>
