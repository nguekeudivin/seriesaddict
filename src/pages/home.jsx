...
const testimonials = [
  {
    ...
    quote:
      "“J’ai enfin compris quoi mettre en place avant de viser les cartes business.”",
  ...
  },
  {
    ...
    role: "CONSULTANTE",
    quote:
      "“La méthode m’a aidée à trouver un financement pour l’activité que je venais de lancer.”",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
  },
  {
    name: "MARCO L.",
    ...
    quote:
      "“Le plus utile a été de savoir quels comptes ouvrir et à quel moment avancer vers le crédit.”",
    videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
  },
];
          ...
          <div className="w-full max-w-4xl overflow-hidden rounded-[28px] bg-white shadow-2xl">
            <div className="flex items-center justify-between border-b border-slate-200 px-5 py-4">
              <div>
                ...
                <p className="text-sm text-slate-500">{selectedVideo.role}</p>
              </div>
              <button
                type="button"
