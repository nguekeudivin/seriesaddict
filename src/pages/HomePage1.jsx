  ...
  return (
    <section className="relative h-[95vh] min-h-[720px] overflow-hidden bg-black">
      ...
      <div className="relative mx-auto flex h-full max-w-7xl flex-col justify-end px-6 pb-16 lg:pb-20">
        <div className="max-w-3xl animate-[fadeInUp_1.2s_ease-out_forwards]">
          ...
          <h1 className="text-6xl font-black uppercase leading-[0.9] tracking-tight text-white md:text-7xl lg:text-[90px]">
            {hero.title}
          </h1>
